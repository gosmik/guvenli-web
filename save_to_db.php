...
{
	mysqli_query($connect,"INSERT into user (user_name,user_surname,user_mail,user_password) VALUES ('".$_POST['username']."', '".$_POST['name']."', '".$_POST['mail']."', '".$_POST['password']."')") or die(mysqli_error($connect));
